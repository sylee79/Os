...
if (isset($_SERVER) && array_key_exists('HTTP_HOST', $_SERVER)) {
	...
	if (array_key_exists($domain, $db_domain_mapping)) {
        $active_group = $db_domain_mapping[$domain];
	} else {
...
$db['sc_dev']['dbdriver'] = 'mysql';
$db['sc_dev']['dbprefix'] = '';
$db['sc_dev']['pconnect'] = TRUE;
$db['sc_dev']['db_debug'] = TRUE;
$db['sc_dev']['cache_on'] = FALSE;
$db['sc_dev']['cachedir'] = '';
$db['sc_dev']['char_set'] = 'utf8';
$db['sc_dev']['dbcollat'] = 'utf8_general_ci';
$db['sc_dev']['swap_pre'] = '';
$db['sc_dev']['autoinit'] = TRUE;
$db['sc_dev']['stricton'] = FALSE;
